...
def main():
    ...
    try:
        running_activities = garmin_client.get_activities_by_date(
        ...
        print(
            f"Running activities found on dates: {[activity['date'] for activity in activities_data]}"
        )
